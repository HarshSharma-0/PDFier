...
const withAndroidMainApplicationAttributes_1 = require("./withAndroidMainApplicationAttributes");
let pkg = {
...
const withShareMenu = (0, config_plugins_1.createRunOncePlugin)((config, params) => {
    return (0, config_plugins_1.withPlugins)(config, [
        ...
        () => (0, withAndroidMainApplicationAttributes_1.withAndroidMainApplicationAttributes)(config, params),
