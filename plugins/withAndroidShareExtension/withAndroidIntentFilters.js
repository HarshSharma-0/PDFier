...
function addIntentFilters(androidManifest, currentIntentFilters, filters) {
    ...
    const multipleFilter = filters || ["text/*"];
   ...
   const MultipleFilter = multipleFilter.map((filter) => ({
    ...
    const FinalRenderManifest = newIntentFilters.concat(MultipleFilter);
    const renderedNewIntentFilters = renderIntentFilters(FinalRenderManifest);
