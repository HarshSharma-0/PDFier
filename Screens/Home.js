...
export default function Home() {
  ...
  const {CopyPdf,deleteDirectoryContents,setMode,MaxPdfView,setMaxSelection,BookDir,setCreatedPdfBook,OpenFileManager,OpenRecent,OpenBook,RemovePdfBook,AddPdfBook,CreatedPdfBook,RecentViewed,selectedPDFs,setSelectedPDFs,setOpenFileManager} = usePDFier();
...
<View style={{flexDirection:'row'}}>
 <View style={{backgroundColor:colors.primary,borderTopLeftRadius:RFPercentage(0.5),borderBottomLeftRadius:RFPercentage(0.5)}}>
    <Text style={{color:'white'}}>Book Name: {book.BookName.slice(0, 4)}</Text>
